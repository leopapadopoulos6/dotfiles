...
import {Box, Text, Code, Grid, VStack, Spacer, Card, Heading, Button} from '@chakra-ui/react';
        ...
        <Grid minH="100vh" p={3}>
            <VStack spacing={8}>
                ...
                <Card variant='rounded'>
                    ...
                    <Heading mt={6} maxW={60} size='lg' textAlign='center' color='aqua'>
                        Welcome back, Eric
                    </Heading>
                    <Text mt={6} mb={6} size='sm' color='aqua'>
