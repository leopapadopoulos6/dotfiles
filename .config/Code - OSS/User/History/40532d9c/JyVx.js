...
function NavDrawer() {
  ...
  return (
    <>
      <IconButton colorScheme='bg' color='red' ref={btnRef} icon={<AddIcon />} size='sm' onClick={onOpen} onTouchStart={onOpen}>
        Nav
      </IconButton>
      ...
      >
        ...
        <DrawerContent bgColor='fg' color='bg'>
          ...
          <DrawerFooter>
            ...
            <Button colorScheme='red' color='red' variant='outline' mr={3} onClick={onClose}>
              Close
            </Button>
